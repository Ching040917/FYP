...
import {
  ...
  usePrevious,
  useSize
} from "./chunk-KBION3KW.js";
import {
  Presence,
  clamp,
  useCallbackRef,
  useDirection
} from "./chunk-JKNMBKVT.js";
import {
  composeEventHandlers,
  createContextScope,
  useLayoutEffect2
} from "./chunk-5KFUCC5S.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent,
  require_jsx_runtime
} from "./chunk-NIQOG2DQ.js";
import {
  createSlot,
  useComposedRefs
} from "./chunk-CV7URIK4.js";
import {
  require_react_dom
...
var Portal = React11.forwardRef((props, forwardedRef) => {
  ...
  return container ? ReactDOM2.createPortal((0, import_jsx_runtime7.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function SelectProvider(props) {
  ...
  const handleNativeOptionAdd = React22.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React22.useCallback((option) => {
  ...
  return (0, import_jsx_runtime9.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime9.jsx)(SelectProviderImpl, { scope: __scopeSelect, ...context, children: (0, import_jsx_runtime9.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime9.jsx)(
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime9.jsx)(
    SelectProvider,
    {
      __scopeSelect,
      ...providerProps,
      internal_do_not_use_render: ({ isFormControl }) => (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, { children: [
        children,
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime9.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime9.jsx)(React22.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }
);
...
var SelectPortal = (props) => {
  ...
  return (0, import_jsx_runtime9.jsx)(PortalProvider, { scope: props.__scopeSelect, forceMount, children: (0, import_jsx_runtime9.jsx)(Portal, { asChild: true, ...portalProps }) });
};
...
var SelectContent = React22.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime9.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => present ? (0, import_jsx_runtime9.jsx)(SelectContentImpl, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime9.jsx)(SelectContentFragment, { ...contentProps, fragment }) });
  }
);
SelectContent.displayName = CONTENT_NAME2;
var SelectContentFragment = React22.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, children, fragment } = props;
  if (!fragment) return null;
  return ReactDOM3.createPortal(
    (0, import_jsx_runtime9.jsx)(SelectContentProvider, { scope: __scopeSelect, children: (0, import_jsx_runtime9.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime9.jsx)("div", { ref: forwardedRef, children }) }) }),
    fragment
  );
});
...
var SelectArrow = React22.forwardRef(
  (props, forwardedRef) => {
    ...
    return contentContext.position === "popper" ? (0, import_jsx_runtime9.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
  ...
  ({ __scopeSelect, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime9.jsxs)(
      Primitive.select,
      {
        ...
        children: [
          shouldShowPlaceholder(value) && !hasEmptyValueOption ? (0, import_jsx_runtime9.jsx)("option", { value: "" }) : null,
